...
function AddNewQuestion(currentQuestion) {
    ...
    let questionHtml = '<tr id ="Q_' + TCCounter + '" class="questionContainer">' +
        '<td class ="QuestionNo" scope="row"><h4>' + TCCounter + '.</h4></td>' +
        '<td>' +
        ...
        '<div class="SampleTestCaseInput_' + TCCounter + '">' +
        '<textarea id="SPI_' + numOfSampleTestCase + '" class="SP_' + TCCounter + '"></textarea>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<div class="textarea-wrapper">' +
        '<div class="row">' +
        '<div class="SampleTestCaseInputAndButtons_' + TCCounter + '">' +
        '<div id="SPOB_' + numOfSampleTestCase + '">' +
        '<div class="col-sm-9"><textarea class="SPO_' + TCCounter + '"></textarea></div>' +
        '<div class="col-sm-3">' +
        '<div class="addNewSampleTopic_' + TCCounter + ' btn btn-primary col-sm-2" style="height: 3.5rem;max-width:4rem;" onclick="addSampleTestCases(' + TCCounter + ',' + numOfSampleTestCase + ')">+</div>' +
        '<div class="removeNewSampleTopic_@numOfQuestions btn btn-danger col-sm-2" style="height: 3.5rem;max-width:4rem;" onclick="RemovewSampleTestcase(' + TCCounter + ',' + numOfSampleTestCase + ')">x</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '</div>' +
        '<div class="textarea-wrapper">' +
        '<div class="SecretTestCaseInput_' + TCCounter + '">' +
        '<textarea id="STI_' + numOfSecertTestCase + '" class="ST_' + TCCounter + '"></textarea>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<div>' +
        '<div class="textarea-wrapper">' +
        '<div class="SecretTestCaseInputAndButtons_' + TCCounter + '">' +
        '<div id="STOB_' + numOfSecertTestCase + '" class="row">' +
        '<div class="col-sm-9"><textarea class="STO_' + TCCounter + '"></textarea></div>' +
        '<div class="col-sm-3">' +
        '<div class="addNewSecretTopic_' + TCCounter + ' btn btn-primary col-sm-2" style="height: 3.5rem;max-width:4rem;" onclick="addSecretTestCases(' + TCCounter + ',' + numOfSecertTestCase + ')">+</div>' +
        '<div class="removeNewSecretTopic_' + TCCounter + ' btn btn-danger col-sm-2" style="height: 3.5rem;max-width:4rem;" onclick="RemovewSecretTestcase(' + TCCounter + ',' + numOfSecertTestCase + ')">x</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<div class="addNew btn btn-primary col-sm-2" style="height: 3.5rem;max-width:4rem;" onclick="AddNewQuestion(' + TCCounter + ')">+</div>' +
        '<div class="removeNew btn btn-danger col-sm-2" style="height: 3.5rem;max-width:4rem;" onclick="RemovewQuestion(' + TCCounter + ')">x</div>' +
        '</div>' +
        '</td>' +
        '</tr>';
...
function AddAjaxFunc(allQuestions) {
    $.ajax({
        ...
        data: JSON.stringify({ quesList: allQuestions }),
        dataType: "json",

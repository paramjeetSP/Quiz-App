    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (index, value) {
                ...
                count = count + 1;
                $('#UserFieldArea').append('<tr><td style="text-align: -webkit-center;">' + count + '</td><td style="text-align: -webkit-center;">' + FullDate + '</td><td style="text-align: -webkit-center;">' + value.Email + '</td><td style="text-align: -webkit-center;">' + value.user + '</td><td style="text-align: -webkit-center;">' + value.FName + '</td><td style="text-align: -webkit-center;">' + value.LName + '</td><td style="text-align: -webkit-center;">' + value.RollNo + '</td><td style="text-align: -webkit-center;">' + value.CllgeName + '</td><td style="text-align: -webkit-center;">' + value.Branch + '</td><td style="text-align: -webkit-center;">' + value.topicname + '</td><td style="text-align: -webkit-center;">' + value.subname + '</td><td style="text-align: -webkit-center;">' + value.MobNo + '</td><td style="text-align: -webkit-center;">' + value.Gender + '</td><td style="text-align: -webkit-center;">' + value.score + '</td><td style="text-align: -webkit-center;">' + value.Attempted + '</td><td style="text-align: -webkit-center;">' + value.totalTime + '</td></tr>');
            })
